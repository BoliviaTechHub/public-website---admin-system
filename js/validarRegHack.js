$(document).ready(function(){
 ...
 $('.vm').click(function(event){
  ...
  $('#ap').click(function(event){
    event.preventDefault();
    ce++;
    var c1="<tr><td><input type='text' name='c"+ce+"' placeholder='Correo participante"+ce+"' class='email required auto' title='Debe ser correo' autocomplete='off'></td>";
    var c2="<td><input type='text' placeholder='Nombre participante "+ce+"' class='required' title='Campo requerido' autocomplete='off'></td></tr>"
    $('#cp').val(ce);
    $('#h').val(hack);
    $("#tbodyRE").append(c1+c2);
  });
